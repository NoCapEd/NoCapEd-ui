  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-secondary mb-4">Color Preferences</h2>
        <ColorSwitcher />
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-secondary mb-4">Font Preferences</h2>
        <FontSwitcher />
      </section>
